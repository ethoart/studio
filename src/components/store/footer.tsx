...
export function Footer() {
  ...
  return (
    <footer className="border-t bg-background text-foreground"> {/* Ensure bg-background is white */}
        ...
        <div className="grid grid-cols-1 gap-12 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              ...
              <li><Link href="/shop?category=new-arrivals" className="text-muted-foreground hover:text-primary transition-colors">New Arrivals</Link></li>
              <li><Link href="/shop?category=best-sellers" className="text-muted-foreground hover:text-primary transition-colors">Best Sellers</Link></li>
          ...
          <div>
            ...
            <form className="flex gap-2">
              ...
              <Button type="submit" variant="default" className="bg-primary text-primary-foreground hover:bg-primary/90"> {/* Solid black button */}
                Subscribe
              </Button>
            </form>
            <div className="mt-8 flex space-x-5">
              <a href="https://web.facebook.com/profile.php?id=100076276321366" target="_blank" rel="noopener noreferrer" className="text-muted-foreground hover:text-primary transition-colors" aria-label="Facebook">
                <Facebook className="h-5 w-5" />
              </a>
              <a href="https://www.instagram.com/arobazzar/" target="_blank" rel="noopener noreferrer" className="text-muted-foreground hover:text-primary transition-colors" aria-label="Instagram">
